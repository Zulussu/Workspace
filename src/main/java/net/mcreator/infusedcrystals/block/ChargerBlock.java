...
import net.mcreator.infusedcrystals.gui.ChargerInterfaceGui;
...
public class ChargerBlock extends InfusedCrystalsModElements.ModElement {
	@ObjectHolder("infused_crystals:charger")
	public static final Block block = null;
	@ObjectHolder("infused_crystals:charger")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;

	public ChargerBlock(InfusedCrystalsModElements instance) {
		super(instance, 26);
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						return new ChargerInterfaceGui.GuiContainerMod(id, inventory,
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public Container createMenu(int id, PlayerInventory player) {
			return new ChargerInterfaceGui.GuiContainerMod(id, player, new PacketBuffer(Unpooled.buffer()).writeBlockPos(this.getPos()));
		}

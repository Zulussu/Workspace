...
public class ChargercodeProcedure {

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				InfusedCrystalsMod.LOGGER.warn("Failed to load dependency world for procedure Chargercode!");
			return;
		}
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				InfusedCrystalsMod.LOGGER.warn("Failed to load dependency x for procedure Chargercode!");
			return;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				InfusedCrystalsMod.LOGGER.warn("Failed to load dependency y for procedure Chargercode!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				InfusedCrystalsMod.LOGGER.warn("Failed to load dependency z for procedure Chargercode!");
			return;
		}
